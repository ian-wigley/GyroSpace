...
//	Method to return the WICFactory 
IWICImagingFactory2* DirectXBase::GetWICFactory()
{
	return m_wicFactory.Get();
}

//	Method to return the D2DContext
ID2D1DeviceContext* DirectXBase::GetD2DContext()
{	
